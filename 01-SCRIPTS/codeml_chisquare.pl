...
MAIN: {
    ...
    calculate_chisquare($rh_lnls,$rh_o->{'df'});
}
...
sub usage {
    print "codeml_chisquare.pl --codeml_dir=CODEML_DIR --alt_suf=ALT_SUFFIX --null_suf=NULL_SUFFIX --df=DEGREES_OF_FREEDOM [--help] [--version]\n";
    exit;
}
...
codeml_chisquare.pl --codeml_dir=CODEML_DIR --alt_suf=ALT_SUFFIX --null_suf=NULL_SUFFIX --df=DEGREES_OF_FREEDOM [--help] [--version]
