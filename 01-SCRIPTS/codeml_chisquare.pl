...
sub usage {
    print "codeml_chisquare.pl --codeml_dir=CODEML_DIR --alt_suf=ALT_SUFFIX --null_suf=NULL_SUFFIX [--help] [--version]\n";
    exit;
}
...
codeml_chisquare.pl --codeml_dir=CODEML_DIR --alt_suf=ALT_SUFFIX --null_suf=NULL_SUFFIX [--help] [--version]
